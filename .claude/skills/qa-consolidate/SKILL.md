...
Consolidate QA testing plans from merged PT PRs onto the parent ENG PR. Use when the user wants to consolidate QA, update QA plan, update testing plan on ENG PR, merge QA plans, prepare release QA, generate missing QA plans, or retroactively create QA plans for merged PRs.
