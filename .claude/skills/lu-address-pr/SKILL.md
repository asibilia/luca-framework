...
Address PR review comments by swarming reviewer agents, validating concerns, planning fixes, executing, verifying, and responding to comments. Use when user wants to address PR feedback, handle review comments, mentions /lu-address-pr, or needs to respond to PR reviewers.
...
| --------- | --------------------------------------------------- | ----------------------------- |
| No input  | `/lu-address-pr`                                 | Detect PR from current branch |
| PR number | `/lu-address-pr 123`                             | Use specified PR number       |
| PR URL    | `/lu-address-pr https://github.com/.../pull/123` | Parse PR from URL             |
...
| More work needed | Continue execution | `/lu-execute-phase {phase}` |
