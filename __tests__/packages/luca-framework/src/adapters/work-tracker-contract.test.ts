 ...
 * - GitHub: Bun.$ global override via mock-shell
...
const adapterSetups: AdapterSetup[] = [
  {
    ...
    create: async () => {
      ...
      const restoreShell = installShellMock(shellMock);

      const { createGitHubAdapter } =
        await import("../../../../../packages/luca-framework/src/adapters/github-adapter");
      return { adapter: createGitHubAdapter(), cleanup: restoreShell };
    },
  },
  {
    name: "jira",
    ...
    create: async () => {
      ...
      const { createJiraAdapter } =
        await import("../../../../../packages/luca-framework/src/adapters/jira-adapter");
      return {
  ...
  },
  {
    ...
    ticketId: "PT-0000",
    create: async () => {
      const { createPlaceholderAdapter } =
        await import("../../../../../packages/luca-framework/src/adapters/placeholder-adapter");
