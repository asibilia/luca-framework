import { z } from "zod";
import type { PhaseQualityMetrics } from "../__schemas/memory.schemas";
import { phaseQualityMetricsSchema } from "../__schemas/memory.schemas";
import type { HarnessResult } from "~/harness/__schemas/harness.schemas";
