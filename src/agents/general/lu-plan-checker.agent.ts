/**
 * lu-plan-checker Agent - Verifies plans will achieve phase goal before execution. Goal-backward analysis of plan quality. Spawned by /phase-plan orchestrator.
 */
...
- [ ] Result returned to orchestrator
    ...
    {
      title: "review_loop",
      content: `## Review Loop Protocol (v2 — Convergence Detection)

lu-plan-checker supports multi-pass review when invoked by an orchestrator managing a plan review loop. The agent itself is stateless between invocations — the orchestrator passes iteration context.
...
export const luPlanCheckerAgent = createAgent(luPlanCheckerConfig);
