...
const luTestWriterConfig: AgentConfig = {
  frontmatter: {
    ...
    cognition: {
      default_tier: "T1",
      promotable_to: "T2",
      memory_tags: ["testing", "patterns", "conventions"],
    },
    context: {
      default_tier: "T1",
      promotable_to: "T2",
  ...
  sections: [
    {
      title: "role",
      content: `You are a Luca test-first writer. You generate failing tests from plan specifications before implementation begins.
...
This is read-only memory access. Do NOT write to WORKING.md or attempt learning extraction.
    ...
    {
      title: "test_generation_process",
      content: `## Test Generation Process
...
Report the failure count and types. All tests should fail (Red phase confirmation).`,
    ...
    {
      title: "test_patterns",
      content: `## Test Patterns Reference
...
- Use descriptive test names that explain the expected behavior.`,
    ...
    {
      title: "non_testable_detection",
      content: `## Non-Testable Work Detection
