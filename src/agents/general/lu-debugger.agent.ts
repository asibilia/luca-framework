...
2. **Check for known pitfalls**
   - Common gotchas in this area of the codebase
   - Framework/library-specific issues
   - Integration points that tend to fail
...
- Avoid repeating past debugging mistakes
- Apply successful debugging patterns
- Skip already-disproven hypotheses
...
export const luDebuggerAgent = createAgent(luDebuggerConfig);
