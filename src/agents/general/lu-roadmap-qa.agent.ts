/**
 * lu-roadmap-qa Agent - Testing gap analysis and QA impact assessment for roadmap revision.
 * Evaluates tech debt severity, CI/CD impact, and verification requirements for pending todos.
...
const luRoadmapQaConfig: AgentConfig = {
  frontmatter: {
    name: "lu-roadmap-qa",
    description:
    ...
    cognition: {
      default_tier: "T1",
      promotable_to: "T1",
      memory_tags: ["testing", "pitfalls", "verification", "quality"],
    },
    context: {
      default_tier: "T1",
      promotable_to: "T2",
  ...
  sections: [
    {
      title: "role",
      content: `You are a Luca roadmap QA analyst. You assess pending todos from a quality assurance perspective — evaluating testing gaps, tech debt severity, CI/CD impact, and verification overhead.
...
export const luRoadmapQaAgent = createAgent(luRoadmapQaConfig);
