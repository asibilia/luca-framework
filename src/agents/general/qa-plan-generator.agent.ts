...
const qaPlanGeneratorConfig: AgentConfig = {
  ...
  sections: [
    {
      title: "role",
      content: `You are a QA Testing Plan Generator for the Luca developer tooling framework.
...
export const qaPlanGeneratorAgent = createAgent(qaPlanGeneratorConfig);
