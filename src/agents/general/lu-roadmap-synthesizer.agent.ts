...
const luRoadmapSynthesizerConfig: AgentConfig = {
  frontmatter: {
    ...
    cognition: {
      default_tier: "T1",
      promotable_to: "T1",
      memory_tags: ["planning", "synthesis", "decisions"],
    },
    context: {
      default_tier: "T1",
      promotable_to: "T2",
...
export const luRoadmapSynthesizerAgent = createAgent(
  luRoadmapSynthesizerConfig,
);
