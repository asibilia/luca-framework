/**
 * lu-roadmap-architect Agent - Architectural impact analyzer for roadmap revision.
 * Assesses dependency ordering, tier implications, and structural risk for pending todos.
...
const luRoadmapArchitectConfig: AgentConfig = {
  frontmatter: {
    ...
    cognition: {
      default_tier: "T1",
      promotable_to: "T1",
      memory_tags: ["architecture", "dependencies", "patterns"],
    },
    context: {
      default_tier: "T1",
      promotable_to: "T2",
    ...
    purpose: "reviewer",
    allowed_contexts: ["planning", "roadmap", "architecture"],
  },
  sections: [
    {
      title: "role",
...
export const luRoadmapArchitectAgent = createAgent(luRoadmapArchitectConfig);
