...
// Define the lu-plan-session skill configuration
...
/**
 * lu-plan-session skill implementation
 */
export class LuPlanSessionSkill extends BaseSkillImpl {
  constructor() {
    super(luPlanSessionConfig);
  }
}
