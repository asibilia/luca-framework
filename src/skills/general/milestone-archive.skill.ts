/**
 * milestone-archive Sub-Skill — Archive milestone, generate stats, write retro.
 *
 * Extracts Steps 1-7.5 from the monolithic milestone-complete skill. This is
 * the largest sub-skill, covering milestone memory archival, session cleanup,
 * stats gathering, accomplishment extraction, file archival, PROJECT.md update,
 * GitHub milestone creation, and process retrospective.
 *
 * **Responsibility:** Execute the bulk of the milestone completion workflow:
 * archive completed phases, generate milestone statistics, write retrospective,
 * create GitHub milestone, and write results to the shared context file.
 *
 * **Input:** Milestone version (from orchestrator context)
 * **Output:** Populated `milestone_archive` section in `/tmp/milestone-complete-context.json`
 *
 * @see .planning/phases/224-anti-skip-rollout/01-PLAN.md Task 6
 */
import { createSkill } from "~/skills/__helpers/create-skill";

import type { SkillConfig } from "~/skills/__schemas/skill.schemas";

const milestoneArchiveConfig: SkillConfig = {
  frontmatter: {
...
export const milestoneArchiveSkill = createSkill(milestoneArchiveConfig);
