/**
 * outcome Skill - Record whether a shipped feature achieved its intended goal. Tracks outcomes in MuninnDB for long-term process learning.
 */
import { createSkill } from "~/skills/__helpers/create-skill";
import type { SkillConfig } from "~/skills/__schemas/skill.schemas";

// Define the outcome skill configuration
...
export const outcomeSkill = createSkill(outcomeConfig);
