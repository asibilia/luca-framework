/**
 * rule-complexity-gating Skill - Five complexity levels (TRIVIAL to CRITICAL) with model routing matrix for per-agent model selection.
 */
...
const ruleComplexityGatingConfig: SkillConfig = {
  frontmatter: {
    ...
    description: `Five complexity levels (TRIVIAL to CRITICAL) with model routing matrix for per-agent model selection.`,
    "disable-model-invocation": true,
  },
  sections: [
    {
      title: "main",
      content: `## Five Complexity Levels
...
export const ruleComplexityGatingSkill = createSkill(
  ruleComplexityGatingConfig,
);
