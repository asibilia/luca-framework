...
\`\`\`
IF $BACKLOG_COUNT > 0:
  Agent(name: "backlog", subagent_type: "lu-pm-planner", model: ORCHESTRATOR_MODEL,
...
FOR attempt = 1 to $REVIEW_FIX_ITERATIONS:
  Agent(name: "review-fix-{NN}-{attempt}", subagent_type: "lu-executor", model: ORCHESTRATOR_MODEL,
