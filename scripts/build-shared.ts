...
function generatePiOutputs(generated: Map<string, string>): void {
  // Pi settings.json
  generated.set(
    ".pi/settings.json",
...
export async function generateAllOutputs(): Promise<Map<string, string>> {
  ...
  // Pi-specific outputs (settings.json; agents, skills, and AGENTS.md
  // are already generated by the entity functions above)
  generatePiOutputs(generated);
