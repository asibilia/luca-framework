...
@./.cursor/luca/references/git-integration.md
</required_reading>
...
See ./.cursor/luca/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `./.cursor/luca/templates/user-setup.md`.
...
Use ./.cursor/luca/templates/summary.md for structure.
