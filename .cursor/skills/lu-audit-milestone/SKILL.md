...
/lu-complete-milestone — archive and celebrate
...
/lu-complete-milestone — proceed anyway (tech debt noted)
...
|-----------|--------|---------|
| Audit passed | Complete milestone | `/lu-complete-milestone` |
| Gaps found | Plan gap closure | `/lu-plan-milestone-gaps` |
| Want to review | Check progress | `/lu-progress` |

**Primary:** `/lu-complete-milestone` — Archive and prepare for next (if audit passed)
