...
**After this command:** Run `/lu-plan-phase [N]` to start execution.
...
|-----------|--------|---------|
| Milestone created | Discuss first phase | `/lu-discuss-phase {N}` |
| Want to skip discussion | Plan directly | `/lu-plan-phase {N}` |
| Need codebase context | Map the codebase | `/lu-map-codebase` |
