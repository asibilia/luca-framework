...
See ./.cursor/origin/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.cursor/origin/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.cursor/origin/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.cursor/origin/templates/discovery.md
...
Use ./.cursor/origin/templates/discovery.md.
