...
@./.cursor/origin/references/git-integration.md
</required_reading>
...
See `./.cursor/origin/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See ./.cursor/origin/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `./.cursor/origin/templates/user-setup.md`.
...
Use ./.cursor/origin/templates/summary.md for structure.
