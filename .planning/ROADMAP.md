...
- [x] PLAN: Dashboard ErrorBoundary + loading state (M19-M20) and accessibility pass (M21-M22, M24-M25)
- [x] PLAN: Extract context_isolation shared block (M17), todos route Bun API (M23), DX cleanup (M10, M12)
