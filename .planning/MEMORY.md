...
- Total patterns: 83 (+3 Phase 43: profile-based rule organization, lazy factory pattern, git mv for migration)
- Total decisions: 40 (+2 Phase 43: synchronous readFileSync for config, empty placeholder profiles)
- Total pitfalls: 51 (+2 Phase 43: hardcoded directory paths in tests, Record indexing returns undefined)
- Total conventions: 4 (no change)
- Total anti-patterns: 6 (no change)
- Total preferences: 9 (no change)
- Last updated: 2026-02-16

_Entries added by: lu-learner (Phase 43 learning extraction)_
