...
- Files: `.cursor/skills/lu/SKILL.md`, `.cursor/skills/git-feature/SKILL.md`, `.cursor/skills/qa-consolidate/SKILL.md`, `.cursor/rules/lu-workflow.mdc`, `.cursor/origin/templates/state.md`, `docs/agent-framework/luca/README.md`
...
- Files: `.cursor/skills/lu/SKILL.md`, `.cursor/skills/qa-consolidate/SKILL.md`, `.cursor/origin/workflows/resume-project.md`
...
- Issue: `.cursor/origin/` path hardcoded in many references
- Files: Multiple skills reference `@./.cursor/origin/workflows/`, `.cursor/origin/templates/`, `.cursor/origin/references/`
...
- Files: `.cursor/rules/taskmaster.mdc`, `.cursor/rules/atlassian-mcp.mdc`, `.cursor/skills/jira-issue/SKILL.md`, `.cursor/origin/templates/user-setup.md`
...
- Files: `.cursor/origin/templates/user-setup.md`, `.cursor/origin/references/verification-patterns.md`
...
- Files: `.cursor/origin/workflows/verify-phase.md`, `.cursor/agents/lu-verifier.md`
...
- Files: Multiple skills use `@./.cursor/origin/workflows/{name}.md` references
...
- Files: `.cursor/origin/templates/*.md` contain `{{PLACEHOLDERS}}` and `[Placeholder text]`
...
- Files: All workflow files in `.cursor/origin/workflows/`
...
- Issue: Framework assumes `.cursor/origin/`, `.planning/`, `.cursor/skills/` structure
