...
- `.cursor/luca/workflows/*.md`: Orchestrator workflows
- `.planning/phases/XX-name/*-PLAN.md`: Executable plans

**Templates:**

- `.cursor/luca/templates/*.md`: Document templates
- `.cursor/luca/templates/codebase/*.md`: Codebase analysis templates
...
- Workflow: `.cursor/luca/workflows/{workflow-name}.md` (if orchestrator needed)
...
- Implementation: `.cursor/luca/references/{topic}.md`
- Pattern: Pattern definitions with examples and guidelines
