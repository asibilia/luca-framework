...
- **Phase B** — port logic into `luca-core` — in progress, **8 of ~14
  subsystems** done:
  ...
  - **next:** `confidence-journal`, then `claim-verifier` ·
    `review-analysis` · `postmortem` · `rule-engine` runner + recurrence ·
    `preferences`.
