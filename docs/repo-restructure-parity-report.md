...
| Remove Cursor / Pi support                                          | ✅ yes | All `.cursor/` (37 files) and `.pi/` (15 files) tracked files are under `packages/luca-framework/` — deleted as part of the husk removal. None outside `.luca/archive/00-legacy-planning/` or the husk.                                                                                                                                |
| Preserve `.luca/archive/00-legacy-planning/`                                | ✅ yes | Directory exists at repo root with all slim-down spec subdirs intact: `planning/`, `migration/`, `milestones/`, `notes/`, `plans/`, `research/`, `summaries/`, `codebase/`, `done/`. Plan §9 explicitly requires preservation.                                                                                                  |
...
7. **Future — Workflow slim-down.** Plan §9 defers the
   `.luca/archive/00-legacy-planning/` pipeline redesign (~11 specs) to
