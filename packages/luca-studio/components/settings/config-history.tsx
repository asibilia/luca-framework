                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div className="space-y-1.5">
                                    <p className="text-sm font-medium text-warning">
                                        ...
                                        {publishBlockedFiles.length} uncommitted
                                        file
                                        {publishBlockedFiles.length === 1
                                            ? ''
                                            : 's'}{' '}
                                        outside Studio:
                                    </p>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Resolution: commit or stash these files
                                        from your terminal.
                                    </p>
                                </div>
                            </div>
                ...
                {state === 'loaded' && commits.length === 0 && (
                    <div className="flex flex-col items-center gap-2 py-8 text-center text-muted-foreground">
                        ...
                        <p className="text-xs text-muted-foreground/60">
                            Edit entities and click Publish to create your first
                            commit.
                        </p>
                    </div>
                )}
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            ? This will overwrite the current version of the
                            file.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
