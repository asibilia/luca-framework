                    ...
                    <>
                        ...
                        <div className="space-y-1">
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    MuninnDB uses two vaults: a repo vault for
                                    project-specific memories and a default
                                    vault for cross-cutting patterns and
                                    preferences.
                                </TooltipContent>
                            </Tooltip>
