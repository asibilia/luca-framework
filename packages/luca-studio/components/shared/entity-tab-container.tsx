        ...
        >
            ...
            {hasCompiledTab && (
                ...
                >
                    ...
                    {compileStatus.state !== 'idle' && sseMatchesEntity && (
                        <CompileStatusBanner
                            state={compileStatus.state}
                            domain={compileStatus.domain}
                            name={compileStatus.name}
                            error={
                                'error' in compileStatus
                                    ? compileStatus.error
                                    : undefined
                            }
                        />
                        ...
                        compiledError === 'sidecar-offline' && (
                            <>
                                <div className="mb-3 flex items-center gap-2 rounded-md border border-border/50 bg-muted/50 px-3 py-2 text-xs text-muted-foreground">
                                    ...
                                    <span>
                                        Compilation sidecar is offline. Showing
                                        local placeholder. Start the sidecar
                                        with{' '}
