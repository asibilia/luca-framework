...
export function ComplexityTab() {
    ...
    const matrix = useMemo(() => {
        return get(complexitySection, 'matrix', {}) as Record<
            string,
            LevelBudget
        >
    }, [complexitySection])
        ...
        <div className="space-y-6">
            ...
            <div>
                <Tooltip>
                    ...
                    <TooltipContent>
                        Controls how many retry iterations each verification
                        step gets at each complexity level. Higher budgets allow
                        more fix attempts before failing.
                    </TooltipContent>
                </Tooltip>
                                    ...
                                    >
                                        ...
                                        <td className="px-2 py-1.5">
                                            <Input
                                                ...
                                                max={10}
                                                value={
                                                    budget.planVerificationIterations ??
                                                    1
                                                }
                                                onChange={(e) =>
                                                    updateBudgetField(
