...
- \`planning_root_allowlist\`: ["config.json", "state.json", "session-ledger.jsonl", "ROADMAP.md", "PROJECT.md", "CANONICAL-DECISIONS.md", "MILESTONE-AUDIT.md", ".context-metrics.json", "checks-result.json"]
