...
const ALWAYS_FAST: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "fast", MODERATE: "fast", COMPLEX: "fast", CRITICAL: "fast",
};

const FAST_PROMOTED: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "fast", MODERATE: "fast", COMPLEX: "fast", CRITICAL: "balanced",
};

const ROUTER: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "fast", MODERATE: "balanced", COMPLEX: "balanced", CRITICAL: "balanced",
};

const ORCHESTRATOR: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "balanced", MODERATE: "balanced", COMPLEX: "capable", CRITICAL: "capable",
};

const DEEP_ANALYSIS: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "balanced", MODERATE: "capable", COMPLEX: "capable", CRITICAL: "capable",
};

const DEFAULT_ROW: RoutingRow = {
  TRIVIAL: "fast", SIMPLE: "fast", MODERATE: "balanced", COMPLEX: "capable", CRITICAL: "capable",
};
...
export function resolveModel({
  ...
  const adjustedTier = adjustTier({ tier: baseTier, profile, agentName: subagentType });
