...
const BUDGET_MATRIX: Record<string, Record<string, BudgetLimits>> = {
  TRIVIAL: {
    budget: { maxChecksFixIterations: 1, maxVerifyIterations: 1, maxPlanReviewIterations: 0, maxResearchReviewIterations: 0, maxReviewIterations: 0, maxPhases: 1 },
    balanced: { maxChecksFixIterations: 2, maxVerifyIterations: 1, maxPlanReviewIterations: 1, maxResearchReviewIterations: 0, maxReviewIterations: 1, maxPhases: 1 },
    quality: { maxChecksFixIterations: 3, maxVerifyIterations: 2, maxPlanReviewIterations: 1, maxResearchReviewIterations: 1, maxReviewIterations: 1, maxPhases: 2 },
  },
  SIMPLE: {
    budget: { maxChecksFixIterations: 2, maxVerifyIterations: 1, maxPlanReviewIterations: 1, maxResearchReviewIterations: 0, maxReviewIterations: 1, maxPhases: 2 },
    balanced: { maxChecksFixIterations: 3, maxVerifyIterations: 2, maxPlanReviewIterations: 1, maxResearchReviewIterations: 1, maxReviewIterations: 1, maxPhases: 3 },
    quality: { maxChecksFixIterations: 4, maxVerifyIterations: 2, maxPlanReviewIterations: 2, maxResearchReviewIterations: 2, maxReviewIterations: 2, maxPhases: 4 },
  },
  MODERATE: {
    budget: { maxChecksFixIterations: 3, maxVerifyIterations: 2, maxPlanReviewIterations: 1, maxResearchReviewIterations: 1, maxReviewIterations: 1, maxPhases: 3 },
    balanced: { maxChecksFixIterations: 4, maxVerifyIterations: 2, maxPlanReviewIterations: 2, maxResearchReviewIterations: 2, maxReviewIterations: 2, maxPhases: 5 },
    quality: { maxChecksFixIterations: 5, maxVerifyIterations: 3, maxPlanReviewIterations: 3, maxResearchReviewIterations: 3, maxReviewIterations: 3, maxPhases: 7 },
  },
  COMPLEX: {
    budget: { maxChecksFixIterations: 4, maxVerifyIterations: 2, maxPlanReviewIterations: 2, maxResearchReviewIterations: 2, maxReviewIterations: 2, maxPhases: 5 },
    balanced: { maxChecksFixIterations: 5, maxVerifyIterations: 3, maxPlanReviewIterations: 3, maxResearchReviewIterations: 3, maxReviewIterations: 2, maxPhases: 7 },
    quality: { maxChecksFixIterations: 6, maxVerifyIterations: 4, maxPlanReviewIterations: 4, maxResearchReviewIterations: 4, maxReviewIterations: 3, maxPhases: 10 },
  },
  CRITICAL: {
    budget: { maxChecksFixIterations: 5, maxVerifyIterations: 3, maxPlanReviewIterations: 3, maxResearchReviewIterations: 3, maxReviewIterations: 2, maxPhases: 7 },
    balanced: { maxChecksFixIterations: 6, maxVerifyIterations: 4, maxPlanReviewIterations: 4, maxResearchReviewIterations: 4, maxReviewIterations: 3, maxPhases: 10 },
    quality: { maxChecksFixIterations: 8, maxVerifyIterations: 5, maxPlanReviewIterations: 5, maxResearchReviewIterations: 5, maxReviewIterations: 4, maxPhases: 15 },
  },
};
