...
export const classifyComplexityTool = createTool({
    ...
    inputSchema: z.object({
        taskDescription: z
            .string()
            .describe('Description of the development task'),
        ...
        crossCuttingConcerns: z
            ...
            .optional()
            .describe(
                'List of cross-cutting concerns (e.g., auth, state management, API changes)'
            ),
        ...
        affectedDomains: z
            .array(z.string())
            .optional()
            .describe('List of affected architectural domains'),
    }),
