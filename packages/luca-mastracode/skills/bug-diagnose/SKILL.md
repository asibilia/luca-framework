...
name: bug-diagnose
description: >
  Disciplined diagnosis loop for hard bugs and performance regressions. Build a feedback loop
  first, then reproduce, hypothesise, instrument, fix, and clean up. Use when user says
  "diagnose this", "debug this", reports a bug, says something is broken/throwing/failing,
  describes a performance regression, or invokes /bug-diagnose.
---
