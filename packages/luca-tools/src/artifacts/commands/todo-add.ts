/**
 * todo-add slash command — Add a new item to the development backlog.
 *
 * Ported from ~/.claude/commands/todo-add.md (user copy canonical) (E-6).
 */
...
export const todoAddCommand = defineCommand({
    name: 'todo-add',
