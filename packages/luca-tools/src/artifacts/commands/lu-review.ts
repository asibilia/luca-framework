/**
 * lu-review slash command — Re-enter the Luca pipeline at the review step to audit completed work.
 *
 * Ported from ~/.claude/commands/lu-review.md (user copy canonical) (E-6).
 */
...
export const luReviewCommand = defineCommand({
    name: 'lu-review',
    description:
