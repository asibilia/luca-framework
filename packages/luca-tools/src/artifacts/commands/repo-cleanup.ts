/**
 * repo-cleanup slash command — Scan the repository for AI-session debris and optionally clean it up.
 *
 * Ported from ~/.claude/commands/repo-cleanup.md (user copy canonical) (E-6).
 */
...
export const repoCleanupCommand = defineCommand({
    name: 'repo-cleanup',
    description:
