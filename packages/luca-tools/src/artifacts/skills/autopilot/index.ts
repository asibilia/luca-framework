/**
 * autopilot skill — Autonomous orchestrator that drives backlog, roadmap, plan, execute, and milestone workflows with configurable oversight.
 *
 * Ported from fd0b169be:packages/luca-framework/.cursor/skills/autopilot/SKILL.md (pre-D-4) (E-5).
...
export const autopilotSkill = defineSkill({
    name: "autopilot",
