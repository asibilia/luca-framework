/**
 * repo-audit skill — Run repo structure audit to detect naming violations, orphaned files, and convention drift. Supports quick and full audit modes.
 *
 * Ported from fd0b169be:packages/luca-framework/.cursor/skills/repo-audit/SKILL.md (pre-D-4) (E-5).
