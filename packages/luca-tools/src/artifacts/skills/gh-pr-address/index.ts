/**
 * gh-pr-address skill — Address PR review comments — fetch, filter stale, categorize, fix, respond, regression-check.
 *
 * Ported from fd0b169be^:packages/luca-framework/skills/commands/gh-pr-address.md (pre-D-4) (E-5).
