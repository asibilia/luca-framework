  ...
  return (
    <div className="border-b border-border/50 last:border-b-0">
      <button
        ...
        onClick={() => setExpanded(!expanded)}
        aria-expanded={expanded}
        className="flex w-full items-center gap-3 px-4 py-2 text-left hover:bg-muted/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
      >
        <span className="shrink-0 rounded bg-primary px-1.5 py-0.5 font-mono text-xs font-medium text-primary-foreground">
          {action}
        </span>
