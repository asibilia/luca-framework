 ...
 *
 * NOTE: This module is duplicated from src/shared/__helpers/sql-sanitize.ts.
 * The two packages are isolated by design and cannot cross-import.
 * If you modify this file, update the other copy as well.
 *
 * Copies exist in:
 * - packages/luca-framework/src/state/__helpers/sql-sanitize.ts (this file)
 * - src/shared/__helpers/sql-sanitize.ts
 *
 * @module luca-state/sql-sanitize
 */
