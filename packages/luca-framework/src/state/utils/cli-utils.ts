/**
 * CLI argument parsing utilities for luca-state.
 *
 * Self-contained copy of shared CLI helpers used by bridge, cli,
 * and snapshot modules. No external dependencies.
 *
 * @module luca-state/utils/cli-utils
 */
