...
BRIDGE=$(node -e "console.log(require.resolve('@alecsibilia/luca-framework/state/bridge'))" 2>/dev/null || echo "$PROJECT_DIR/packages/luca-framework/src/state/bridge.ts")
