...
See ./.cursor/luca/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.cursor/luca/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.cursor/luca/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.cursor/luca/templates/discovery.md
...
Use ./.cursor/luca/templates/discovery.md.
