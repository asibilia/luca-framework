...
See ~/.claude/luca/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/luca/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/luca/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/luca/templates/discovery.md
...
Use ~/.claude/luca/templates/discovery.md.
