...
1. **<%= branding.commandPrefix %>-phase-researcher** — Reads CONTEXT.md to know WHAT to research
   - "User wants card-based layout" → researcher investigates card component patterns
   - "Infinite scroll decided" → researcher looks into virtualization libraries

2. **<%= branding.commandPrefix %>-planner** — Reads CONTEXT.md to know WHAT decisions are locked
...
Use /<%= branding.commandPrefix %>-progress to see available phases.
```
...
`/<%= branding.commandPrefix %>-plan-phase ${PHASE}`
...
**Also available:**
- `/<%= branding.commandPrefix %>-plan-phase ${PHASE} --skip-research` — plan without research
