...
@./~/.claude/luca/references/git-integration.md
</required_reading>
...
See ./~/.claude/luca/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `./~/.claude/luca/templates/user-setup.md`.
...
Use ./~/.claude/luca/templates/summary.md for structure.
