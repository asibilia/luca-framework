...
For deep ecosystem research ("how do experts build this"), use `/<%= branding.commandPrefix %>-research-phase` which produces RESEARCH.md.
...
- Use `/<%= branding.commandPrefix %>-research-phase` for these
</guidelines>
