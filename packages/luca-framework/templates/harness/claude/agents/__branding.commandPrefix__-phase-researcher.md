...
4. **Risks** (for `<%= branding.commandPrefix %>-risk-researcher`):
...
### Architecture Research (→ <%= branding.commandPrefix %>-architecture-researcher)
...
### Implementation Research (→ <%= branding.commandPrefix %>-implementation-researcher)
...
### Ecosystem Research (→ <%= branding.commandPrefix %>-ecosystem-researcher)
...
### Risk Research (→ <%= branding.commandPrefix %>-risk-researcher)
...
After all 4 specialists complete, invoke <%= branding.commandPrefix %>-research-synthesizer to merge findings into a unified RESEARCH.md.
```
