...
Scans the repository for AI-session debris: orphaned temp scripts, misplaced files, tool artifacts, dead exports, stale planning artifacts, orphaned/misplaced markdown, and repo-root markdown debris. Outputs a structured ShadowScanReport.
