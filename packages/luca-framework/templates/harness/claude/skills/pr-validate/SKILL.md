...
| Testing       | "test", "coverage", "mock", "assertion"                      | <%= branding.commandPrefix %>-pr-reviewer       |
...
# Repeat for code-architect, performance-auditor, dx-advocate, ux, <%= branding.commandPrefix %>-pr-reviewer
