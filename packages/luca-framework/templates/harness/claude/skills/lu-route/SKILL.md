...
<main>
# <%= branding.commandPrefix %>-route — Parse, Context, Cognition, Classification
...
writeLuContext({
  lu_route: {
    ...
    cognition_ran: <true if <%= branding.commandPrefix %>-cognition ran, false if --skip-memory>,
