# <%= branding.commandPrefix %>-configure
...
<main>
# <%= branding.commandPrefix %>-configure — Configuration & Pre-Flight
...
After writing results, return to the lu orchestrator. The orchestrator will write `current_state: "configured"` and either invoke <%= branding.commandPrefix %>-backlog or send SKIP_BACKLOG.
</main>