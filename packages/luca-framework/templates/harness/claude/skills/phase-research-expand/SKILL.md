...
- G-ACC-* gaps -> typically need <%= branding.commandPrefix %>-implementation-researcher for verification
- G-ACT-* gaps -> typically need <%= branding.commandPrefix %>-implementation-researcher for code examples
...
|------------|-------------------|--------|
| G-COMP-* (missing architecture) | <%= branding.commandPrefix %>-architecture-researcher | Architecture facet gap |
| G-COMP-* (missing ecosystem) | <%= branding.commandPrefix %>-ecosystem-researcher | Ecosystem facet gap |
| G-COMP-* (missing implementation) | <%= branding.commandPrefix %>-implementation-researcher | Implementation facet gap |
| G-COMP-* (missing risk) | <%= branding.commandPrefix %>-risk-researcher | Risk facet gap |
| G-ACC-* (unverified claims) | <%= branding.commandPrefix %>-implementation-researcher | Needs live verification |
| G-ACC-* (outdated versions) | <%= branding.commandPrefix %>-ecosystem-researcher | Needs current ecosystem check |
| G-ACT-* (missing code examples) | <%= branding.commandPrefix %>-implementation-researcher | Needs concrete code |
| G-ACT-* (vague recommendations) | <%= branding.commandPrefix %>-architecture-researcher | Needs specific patterns |
