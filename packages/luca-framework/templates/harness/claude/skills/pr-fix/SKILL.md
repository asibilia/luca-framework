...
- `<%= branding.commandPrefix %>-planner` — Creates fix plan for valid concerns
- `<%= branding.commandPrefix %>-executor` — Implements fixes with atomic commits
- `<%= branding.commandPrefix %>-verifier` — Verifies fixes address original concerns
...
Spawn <%= branding.commandPrefix %>-planner to create a fix plan for all valid concerns:
...
Spawn <%= branding.commandPrefix %>-executor to implement all planned fixes:
...
Spawn <%= branding.commandPrefix %>-verifier to confirm fixes address original concerns:
...
- This skill MUST spawn <%= branding.commandPrefix %>-planner, <%= branding.commandPrefix %>-executor, <%= branding.commandPrefix %>-verifier via Task()
